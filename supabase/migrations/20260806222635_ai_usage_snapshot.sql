-- Server-only aggregate used by the admin AI usage Edge Function.
...
comment on function public.get_ai_usage_snapshot() is
  'Returns counts only for the admin AI usage Edge Function. It never returns prompts, source content, candidate IDs, or provider output.';
